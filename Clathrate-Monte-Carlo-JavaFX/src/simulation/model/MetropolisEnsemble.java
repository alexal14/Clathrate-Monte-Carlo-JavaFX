...
public abstract class MetropolisEnsemble implements IMolecularSimulation {
    ...
    protected int numbOfMolsActual = 272;
    protected int numbOfAtoms = 272*3;
	...
	protected ArrayList<Molecule> moleculesH2   = new ArrayList<Molecule>(numbHydrogenMols);
	protected ArrayList<Molecule> moleculesACET = new ArrayList<Molecule>(numbLargeCages);
	protected ArrayList<Molecule> moleculesTHF  = new ArrayList<Molecule>(numbLargeCages);	
	...
	protected boolean bH2   = false;
	protected boolean bACET = false;
	protected boolean bTHF  = false;
...
//		moleculesArrayCheck(molecules);
		...
		if ( bACET ){
			molecules.addAll(moleculesACET);
		}
...
//      qx,qy,qz - x,y,z coordinates of the point given by vec after rotation        
	...
	protected StringBuilder getStringBuilderAllAtomsXYZ(){
		...
		return makeAllAtomsXYZ(molecules, molModelMap, numbOfAtoms);
	}
